...
func main() {
	...
	{ v, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(-bytesToInt(v))) }
	{ v, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(absInt(bytesToInt(v)))) }
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	stack_dstack.Push(intToBytes(10))
	...
	{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(minInt(bytesToInt(a), bytesToInt(b)))) }
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	stack_dstack.Push(intToBytes(3))
	stack_dstack.Push(intToBytes(7))
	{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(maxInt(bytesToInt(a), bytesToInt(b)))) }
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	stack_dstack.Push(intToBytes(5))
	stack_dstack.Push(intToBytes(3))
	...
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	stack_dstack.Push(intToBytes(16))
	stack_dstack.Push(intToBytes(2))
	{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(bytesToInt(a) >> uint(bytesToInt(b)))) }
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	stack_dstack.Push(intToBytes(5))
	stack_dstack.Push(intToBytes(3))
	{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_bool.Push(boolToBytes(bytesToInt(a) > bytesToInt(b))) }
	stack_dstack.Push(intToBytes(5))
	stack_dstack.Push(intToBytes(5))
	{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_bool.Push(boolToBytes(bytesToInt(a) == bytesToInt(b))) }
	stack_dstack.Push(intToBytes(3))
