...
func main() {
	...
	spawn_tasks = append(spawn_tasks, func() {
		...
		for func() int64 { v, _ := stack_i64.PeekAt(0); return bytesToInt(v) }() < int64(100000) {
	...
	stack_i64.PushAt(1, intToBytes(int64(0))) // var result
	{ v, _ := stack_results.Take(); stack_dstack.Push(v) }
	{ v, _ := stack_dstack.Pop(); stack_i64.PushAt(1, v) } // result = ...
	{ v, _ := stack_i64.PeekAt(1); stack_dstack.Push(v) } // push result
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
