...
func main() {
	stack_i64.PushAt(0, intToBytes(int64(0))) // var total_gcd
	stack_i64.PushAt(1, intToBytes(int64(1))) // var i
	for func() int64 { v, _ := stack_i64.PeekAt(1); return bytesToInt(v) }() <= int64(1000) {
		stack_i64.PushAt(2, intToBytes(int64(0))) // var gcd_a
		stack_i64.PushAt(3, intToBytes(int64(0))) // var gcd_b
		{ v, _ := stack_i64.PeekAt(1); stack_dstack.Push(v) } // push i
		stack_dstack.Push(intToBytes(17))
		{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(bytesToInt(a) * bytesToInt(b))) }
		{ v, _ := stack_dstack.Pop(); stack_i64.PushAt(2, v) } // gcd_a = ...
		{ v, _ := stack_i64.PeekAt(1); stack_dstack.Push(v) } // push i
		stack_dstack.Push(intToBytes(13))
		{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(bytesToInt(a) * bytesToInt(b))) }
		{ v, _ := stack_dstack.Pop(); stack_i64.PushAt(3, v) } // gcd_b = ...
		stack_i64.PushAt(4, intToBytes(int64(0))) // var temp
		for func() int64 { v, _ := stack_i64.PeekAt(3); return bytesToInt(v) }() > int64(0) {
			{ v, _ := stack_i64.PeekAt(2); stack_dstack.Push(v) } // push gcd_a
			{ v, _ := stack_i64.PeekAt(3); stack_dstack.Push(v) } // push gcd_b
			{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(bytesToInt(a) % bytesToInt(b))) }
			{ v, _ := stack_dstack.Pop(); stack_i64.PushAt(4, v) } // temp = ...
			{ v, _ := stack_i64.PeekAt(3); stack_dstack.Push(v) } // push gcd_b
			{ v, _ := stack_dstack.Pop(); stack_i64.PushAt(2, v) } // gcd_a = ...
			{ v, _ := stack_i64.PeekAt(4); stack_dstack.Push(v) } // push temp
			{ v, _ := stack_dstack.Pop(); stack_i64.PushAt(3, v) } // gcd_b = ...
		}
		{ v, _ := stack_i64.PeekAt(0); stack_dstack.Push(v) } // push total_gcd
		{ v, _ := stack_i64.PeekAt(2); stack_dstack.Push(v) } // push gcd_a
		{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(bytesToInt(a) + bytesToInt(b))) }
		{ v, _ := stack_dstack.Pop(); stack_i64.PushAt(0, v) } // total_gcd = ...
		{ v, _ := stack_i64.PeekAt(1); stack_dstack.Push(v) } // push i
