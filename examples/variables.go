...
func main() {
	stack_i64.PushAt(0, intToBytes(int64(42))) // var x
	stack_i64.PushAt(1, intToBytes(int64(10))) // var y
	{ v, _ := stack_i64.PeekAt(0); stack_dstack.Push(v) } // push x
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	{ v, _ := stack_i64.PeekAt(1); stack_dstack.Push(v) } // push y
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	{ v, _ := stack_i64.PeekAt(0); stack_dstack.Push(v) } // push x
	{ v, _ := stack_i64.PeekAt(1); stack_dstack.Push(v) } // push y
	...
	{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(bytesToInt(a) * bytesToInt(b))) }
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	stack_i64.PushAt(2, intToBytes(int64(100))) // var a
	stack_i64.PushAt(3, intToBytes(int64(200))) // var b
	...
	{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(bytesToInt(a) * bytesToInt(b))) }
	{ v, _ := stack_dstack.Pop(); stack_i64.PushAt(4, v) } // let z
	{ v, _ := stack_i64.PeekAt(4); stack_dstack.Push(v) } // push z
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	{ v, _ := stack_i64.PeekAt(0); stack_dstack.Push(v) } // push x
	{ v, _ := stack_i64.PeekAt(1); stack_dstack.Push(v) } // push y
	{ b, _ := stack_dstack.Pop(); a, _ := stack_dstack.Pop(); stack_dstack.Push(intToBytes(bytesToInt(a) + bytesToInt(b))) }
	{ v, _ := stack_dstack.Pop(); stack_i64.PushAt(5, v) } // let sum
	{ v, _ := stack_i64.PeekAt(5); stack_dstack.Push(v) } // push sum
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
	stack_i64.PushAt(6, intToBytes(int64(99))) // var n
	{ v, _ := stack_i64.PeekAt(6); stack_dstack.Push(v) } // push n
	{ v, _ := stack_dstack.Pop(); fmt.Println(bytesToInt(v)) }
