...
func main() {
	...
	stack_physics.Push(floatToBytes(9.800000))
	func() {
		stack_physics.Lock()
		defer stack_physics.Unlock()
		_bytes_a, _err_a := stack_physics.PopRaw()
		...
		var force float64 = (m * a)
		stack_physics.PushRaw(floatToBytes(force))
		return
	}()
	stack_physics.Push(floatToBytes(49.000000))
	func() {
		stack_physics.Lock()
		defer stack_physics.Unlock()
