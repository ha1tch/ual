...
func safe_divide(a int64, b int64) int64 {
...
func main() {
	func() {
		...
		stack_i64.PushAt(2, intToBytes(int64(safe_divide(100, 5)))) // var result1
		{ v, _ := stack_i64.PeekAt(2); stack_dstack.Push(v) } // push result1
	...
	func() {
		...
		stack_i64.PushAt(3, intToBytes(int64(safe_divide(100, 0)))) // var result2
		{ v, _ := stack_i64.PeekAt(3); stack_dstack.Push(v) } // push result2
